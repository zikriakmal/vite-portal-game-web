    ...
    <div className="group flex flex-col overflow-hidden rounded-2xl border border-surface-border bg-surface transition-[transform,box-shadow,border-color] duration-250 ease-out hover:-translate-y-1.5 hover:border-accent hover:shadow-[0_16px_40px_rgba(74,222,128,0.25)]">
      <div className="relative overflow-hidden">
        <img
          src={game.thumbnail}
          alt={game.title}
          className="block h-45 w-full object-cover transition-transform duration-400 ease-out group-hover:scale-[1.06]"
        />
        {game.engine && (
      ...
      <div className="flex flex-1 flex-col gap-2 p-4.5">
        ...
        <a
          ...
          className="mt-2 inline-block rounded-lg bg-linear-to-br from-accent to-accent-soft px-6 py-2.5 text-center font-semibold text-white transition duration-200 hover:-translate-y-px hover:brightness-110"
        >
          Play
        </a>
      </div>
